...
const AboutUs = () => {
  return (
    ...
    <div className="bg-gray-100">
      {/* Header Section */}
      <header className="py-12 bg-blue-500 text-white text-center bg-purple-500">
      ...
      <section className="bg-gray-200 py-16">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-purple-500 rounded-lg overflow-hidden shadow-md">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Abhishek</h3>
              </div>
            </div>
            <div className="bg-purple-500 rounded-lg overflow-hidden shadow-md">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Likith</h3>
              </div>
            </div>
            <div className="bg-purple-500 rounded-lg overflow-hidden shadow-md">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Ravi Teja</h3>
              </div>
            </div>
            <div className="bg-purple-500 rounded-lg overflow-hidden shadow-md">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Upasana</h3>
              </div>
            </div>
            <div className="bg-purple-500 rounded-lg overflow-hidden shadow-md">
              <div className="p-6">
            ...
            <div className="bg-purple-500 rounded-lg overflow-hidden shadow-md">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Alekhya</h3>
              </div>
            </div>
      ...
      <section className="container mx-auto py-16">
        <div className="text-center">
          ...
          <a
            ...
            className="bg-purple-500 text-white py-2 px-6 rounded-full text-lg hover:bg-blue-700 transition duration-300"
          >
            Email Us
          </a>
        </div>
